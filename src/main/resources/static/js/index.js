let subscribeUrl = "http://localhost:8081/sub";
...
$(document).ready(function() {
    ...
    if (document.cookie != null) {
        ...
        let eventSource = new EventSource(subscribeUrl + "?token=" + token.substring(7));
...
function postMemo() {
    ...
    let data = {title: title, content: content, username : "정아"};
...
function addComment(id) {
    ...
    $.ajax({
        ...
        url: `/memo/${id}/comment`,
        contentType: "application/json;charset=utf-8",
        data: JSON.stringify({username : "정아", content: content}),
        success: function (res) {
            getMemo(id);
        }
    })
